...
2. Clone the repository 
    ```sh	
    git clone https://github.com/onathanmateus/Project-Playwright-Scrapping.git
    ```
3. Enter the repository
    ```sh	
    cd Project-Playwright-Scrapping
    ```
...
5. Open the terminal within Visual Studio Code and install all the dependencies using the following command
    ...
    npm install
    ```
6. Use the following command to run the tests 
    ```sh	
    npx playwright test
    ```
If everything went as it should, the project will run the tests and start automating the tasks
